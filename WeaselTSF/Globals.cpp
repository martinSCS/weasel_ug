...
// {1ACD575D-AAA6-B2AB-A7E9-A655282E6F5F}
static const GUID c_clsidTextService = 
{0x1ACD575D, 0xAAA6, 0xB2AB, { 0xA7, 0xE9, 0xA6, 0x55, 0x28, 0x2E, 0x6F, 0x5F }};

// {D4509939-44A7-99E6-3E85-2CB93220D7BA}
static const GUID c_guidProfile = 
{0xD4509939, 0x44A7, 0x99E6, { 0x3E, 0x85, 0x2C, 0xB9, 0x32, 0x20, 0xD7, 0xBA }};

// {3CBF1A40-5457-A005-93BB-1A1D89BE01E8}
static const GUID c_guidLangBarItemButton = 
{0x3CBF1A40, 0x5457, 0xA005, { 0x93, 0xBB, 0x1A, 0x1D, 0x89, 0xBE, 0x01, 0xE8 }};

// {A1A63A71-9C2C-FF9C-9702-DB2B0916C26E}
static const GUID c_guidDisplayAttributeInput =
{0xA1A63A71, 0x9C2C, 0xFF9C, { 0x97, 0x02, 0xDB, 0x2B, 0x09, 0x16, 0xC2, 0x6E }};

#ifdef WEASEL_USING_OLDER_TSF_SDK

/* For Windows 8 */
const GUID GUID_TFCAT_TIPCAP_IMMERSIVESUPPORT =
{0x36548758, 0x5A84, 0xDAA2, { 0xE2, 0xFB, 0x8D, 0xD2, 0xB7, 0x63, 0xCC, 0xC5 }};

const GUID GUID_TFCAT_TIPCAP_SYSTRAYSUPPORT =
{0x698F8DCD, 0x6FF5, 0x4FF9, { 0x2F, 0xFD, 0x15, 0x52, 0xE8, 0x62, 0xC8, 0xF4 }};

#endif

const GUID GUID_LBI_INPUTMODE =
{0xF092F6FD, 0xC99A, 0xD4B6, { 0xAB, 0x67, 0x39, 0xB9, 0x0E, 0xD6, 0x9C, 0x84 }};

const GUID GUID_IME_MODE_PRESERVED_KEY =
{0x91D5FB64, 0x947D, 0x02FF, { 0x39, 0xE3, 0x88, 0x55, 0x64, 0xAD, 0x53, 0x2D }};
#endif
